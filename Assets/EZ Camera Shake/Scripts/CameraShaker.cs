...
public class CameraShaker : MonoBehaviour
{
	...
	void LateUpdate ()
	{
		...
		for (int i = 0; i < cameraShakeInstances.Count; i++) {
			posAddShake = cam.transform.localPosition;
			rotAddShake = cam.transform.localEulerAngles;
			...
			cam.transform.localPosition = posAddShake;
			cam.transform.localEulerAngles = rotAddShake;
		}

	}

//	public IEnumerator MyShake(float magnitude, float time){
//		
////		CameraShakeInstance cc= CameraShakePresets.RoughDriving;
//		CameraShakeInstance cc = new CameraShakeInstance(magnitude, 1f, 0.1f, 0.5f);
//		cc.PositionInfluence = DefaultPosInfluence;
//		cc.RotationInfluence = DefaultRotInfluence;
//			//Instance.StartShake(magnitude,1f, 0.1f);
//		Instance.Shake(cc);
////		cc.DeleteOnInactive=true;
//		yield return new WaitForSeconds(time);
////		cc.CurrentState=CameraShakeState.Inactive;
//
//	}
